...
if (isset($_POST["s_core_usersID"]))
	{
	if (!empty($_POST["s_core_usersID"])) {$viewItem[$config["modulSelect"]."_x_core_usersID"]=0;}
	else {$viewItem[$config["modulSelect"]."_x_core_usersID"]=1;}
	}
else if (isset($_SESSION[$config["modulSelect"]."_s_core_usersID"]) && !empty($_SESSION[$config["modulSelect"]."_s_core_usersID"]))
	{
	$viewItem[$config["modulSelect"]."_x_core_usersID"]=0;
	}
?>