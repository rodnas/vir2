...
if (!defined("K_TCPDF_EXTERNAL_CONFIG")) {
	 ...
	 * installation path
	 */
	define ("K_PATH_MAIN", "../share/pdfmake/");
	
	/**
	 * url path
	 */
	define ("K_PATH_URL", "../share/pdfmake/");
	
	/**
	 * path for PDF fonts
	 */
	define ("FPDF_FONTPATH", "../share/pdfmake/fonts/");
	 ...
	 * blank image
	 */
	define ("K_BLANK_IMAGE", "images/_blank.png");
	 ...
	 * document creator
	 */
	define ("PDF_CREATOR", "PDFMaker");
	
	/**
	 * document author
	 */
	define ("PDF_AUTHOR", "PDFMaker");
	
	/**
	 * header title
	 */
	define ("PDF_HEADER_TITLE", "\nU T A S B I Z T O S Í T Á S");
	
	/**
	 * header description string
	 */
	define ("PDF_HEADER_STRING", "\nH-1132 Budapest, Váci út 36-38.\nTel:(36-1)452-3930 * Fax:(36-1)452-3920\nCégjegyzékszám: 01-10-043228\nFõvárosi Bíróság mint Cégbíróság");
	
	/**
	 * image logo
	 */
	define ("PDF_HEADER_LOGO", "/var/www/html/netrisk.hu-www/images/logo_eub.jpg");
