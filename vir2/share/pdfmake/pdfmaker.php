...
if(!class_exists('TCPDF', false)) {
	 ...
	 */ 
	define('PDF_PRODUCER','TCPDF 1.53.0.TC031 (http://tcpdf.sourceforge.net)');
		...
		*/
		...
		public function Header() {
			if ($this->print_header) {
				...
				// header title
				$this->SetFont($this->header_font[0], 'B', $this->header_font[2] + 4);
				$this->SetX($header_x);
				$this->MultiCell(80, 5, $this->header_title, 0, 'C', 0, 0);
				
				// header string
				$this->SetFont($this->header_font[0], $this->header_font[1], $this->header_font[2]);
				$this->SetX($header_x);
				$this->MultiCell(85, 5, '', 0, 'C', 0, 0);
				$this->MultiCell(50, 3, $this->header_string, 0,  'L', 0);
...
//				$this->Cell(0, $footer_height, $this->l['w_page']." ".$this->PageNo().' / {nb}', 'T', 0, 'R'); 
				$this->Cell(0, $footer_height, ' ', 'T', 0, 'R'); 
			}
		}
		...
		*/
		protected function _getfontpath() {
			if(!defined('FPDF_FONTPATH') AND is_dir('http://www.netrisk.hu/fonts/')) {
				define('FPDF_FONTPATH', 'http://www.netrisk.hu/fonts/');
			}
